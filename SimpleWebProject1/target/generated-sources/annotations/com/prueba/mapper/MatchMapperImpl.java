...
public class MatchMapperImpl implements MatchMapper {
    ...
    @Override
    public MatchesDTO matchToMatchDTO(MatchesEntity match) {
        if ( match == null ) {
            return null;
        }
        ...
        matchesDTO.setIdMatch( match.getIdMatch() );
        matchesDTO.setNameLocal( match.getNameLocal() );
        matchesDTO.setNameVisitor( match.getNameVisitor() );
        matchesDTO.setWinner( match.getWinner() );

        return matchesDTO;
    }

    @Override
    public MatchesEntity matchesDTOToMatches(MatchesDTO matchesDTO) {
        if ( matchesDTO == null ) {
            return null;
        }
        ...
        matchesEntity.setIdMatch( matchesDTO.getIdMatch() );
        matchesEntity.setNameLocal( matchesDTO.getNameLocal() );
        matchesEntity.setNameVisitor( matchesDTO.getNameVisitor() );
        matchesEntity.setWinner( matchesDTO.getWinner() );
